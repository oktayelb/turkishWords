...
adverbial_dikçe = Suffix("adverbial_dikçe", "dikçe", Type.VERB, Type.NOUN, major_harmony=HasMajorHarmony.Yes, minor_harmony=HasMinorHarmony.Yes, group=SuffixGroup.DERIVATIONAL_LOCKING)
VERB2NOUN = [
